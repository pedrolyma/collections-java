...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        // Retorna os elementos que tem a letra R no nome - true ou false e refaz a colecao
        ...
        System.out.println("Tem q todos ter W no nome para true ? " + estudantes.stream().allMatch((elemento) -> elemento.contains("W")));
        ...
        // Retorna o primeiro elemento da coleção, se existir exibe no console ou vazio
